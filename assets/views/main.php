    ...
    <ul>
      ...
      <li class="next-bg-one">
        <a class="scroll-link" id="home-link" href="#home" data-soffset="0">
          <div class="first">
            ...
            <div class="content"><img alt="" title="" src="images/icons/00.png"/></div>
          </div>
          <div class="second">
      ...
      <li class="next-bg-two">
         <a class="scroll-link" id="about-link" href="#about" data-soffset="0">
          <div class="first">
            <div class="arrow-right"></div>
            <div class="content"><img alt="" title="" src="images/icons/01.png"/></div>
          </div>
          <div class="second">
            <div class="arrow-left"></div>
     ...
     <!-- Ending : Nav Block -->
      ...
      <li class="next-bg-four">
        <a class="scroll-link" id="portfolio-link" href="#portfolio" data-soffset="0">
          <div class="first">
            <div class="arrow-right"></div>
            <div class="content"><img alt="" title="" src="images/icons/06.png"/></div>
          </div>
          <div class="second">
            <div class="arrow-left"></div>
      ...
      <li class="next-bg-three">
        <a class="scroll-link" id="services-link" href="#services" data-soffset="0">
          <div class="first">
            <div class="arrow-right"></div>
            <div class="content"><img alt="" title="" src="images/icons/03.png"/></div>
          </div>
          <div class="second">
            <div class="arrow-left"></div>
      ...
      <li class="next-bg-six">
       <a class="scroll-link" id="contact-link" href="#contact" data-soffset="0">
          <div class="first">
            <div class="arrow-right"></div>
            <div class="content"><img alt="" title="" src="images/icons/05.png"/></div>
          </div>
          <div class="second">
            <div class="arrow-left"></div>
...
<div id="logo" class="hidden-xs"><img alt="" title="" src="images/logo.png"/></div>
      ...
      <div class="stripe clearfix">
       ...
       <!-- Tile : Ends -->
        ...
        <div class="tile tile-01 thumb">
          <div class="tile-nav flipX">
            <img alt="" title="" class="img1" src="images/tiles/03a.jpg">
       ...
       <!-- Tile : Starts -->
        <div class="slogan tile-03   text-left">
          <div class="inner">
            <h1>Solvato</h1>
          <h3>Solvato Online Business Solutions</h3>
          </div>
        </div>
       <!-- Tile : Ends -->
       ...
       <!-- Tile : Ends -->
        ...
        <div class="tile tile-01 thumb">
          <div class="tile-nav flipX">
            <img alt="" title="" class="img1" src="images/tiles/02a.jpg">
       ...
       <!-- Tile : Ends -->
        ...
        <div class="tile tile-01 thumb">
          <div class="tile-nav flipY">
            <img alt="" title="" class="img1" src="images/tiles/05a.jpg">
       ...
       <!-- Tile : Ends -->
        ...
        <div class="tile tile-01 thumb">
          <div class="tile-nav flipX">
            <img alt="" title="" class="img1" src="images/tiles/01a.jpg">
...
<section id="about" class="page-section navigation-fadeIn">
      ...
      <section class="container">
        ...
        <div class="row add-top">
          <article class="col-md-12 text-left">
            <p class="welcome-text fx fx-rollIn">Solvato Online Business Solutions
            </p>
          </article>
        </div>
        <div class="row add-top">
          <article class="col-md-12 text-left">
			<h2>Work Smart, Work Moderate</h2>
            <p>Web Developers, data-visualization artists, computer scientists, statisticians, data-miners, business analysts, data analysts and data scientists. We look into continuously value-add services and job content. Data analytics, cloud strategy and enablement, front-end device integration, application development on tablets, and cyber security etc. which will be hot skills of the future</p>
            </p>
          </article>
        </div>        
        <div class="row add-top">
          <article class="col-md-3 col-xs-6 text-center skill-wrap">
            <div class="chart2" data-percent="100">100%<span>PHP</span></div>
          </article> 
          <article class="col-md-3  col-xs-6 text-center skill-wrap">
            <div class="chart3" data-percent="100">100%<span>HTML5</span></div>
          </article>            
          <article class="col-md-3  col-xs-6 text-center skill-wrap">
            <div class="chart4" data-percent="100">100%<span>CSS</span></div>
          </article>               
          <article class="col-md-3 col-xs-6 text-center skill-wrap">
            <div class="chart1" data-percent="100">100%<span>Photoshop</span></div>
          </article>
        </div>
        ...
        <div class="row add-top fx fx-bounceIn">
          ...
          <article class="col-md-7 col-xs-6 mob-hor-full text-left">
            <ul class="be-social">
              ...
              <li><a href="#"><span class="next-bg-three">Read our blog posts</span></a></li>
              <li><a href="#"><span class="next-bg-four">Connect us via Facebook</span></a></li>
...
<section id="portfolio" class="page-section">
      ...
      <section class="container">
        ...
        <div class="row">
          <article class="col-md-12 text-left">
            <h2 class="page-heading page-heading-alt">portfolio</h2>
            <div class="liner"><span></span></div>
          </article>
        </div>
        ...
        <div class="row add-top add-bottom">
          <article class="col-md-12 text-left">
            <p class="welcome-text welcome-text-alt fx fx-bounceIn">We have worked for more than 350 clients over last 10 years. Explore our best works here</p>
          </article>
        </div>
     ...
     <div id="portfolio_thumbs" class="fx fx-slideInLeft">
          ...
          <ul class="sortablePortfolio clearfix">
              ...
              <li data-type="category1" class="simple-bg-one">
                  ...
                  <!-- Info -->
                  <div class="item_info">
                       <h3><a href="photo_item.htm" class="more_info"><span class="next-bg-one">Online Shopping</span></a></h3>
              ...
              <li data-type="category4" class="simple-bg-five">
                  ...
                  <!-- Info -->
                  <div class="item_info">
                       <h3><a href="images/portfolio_zoom/01.jpg" data-gal="prettyPhoto[gallery]"><span class="next-bg-five">Project TItle</span></a></h3>
...
<section id="services" class="page-section next-bg-four">
      ...
      <section class="container">
        ...
        <div class="row">
          <article class="col-md-12 text-left">
            <h2 class="page-heading page-heading-alt">Our services</h2>
            <div class="liner"><span></span></div>
          </article>
        </div>
        ...
        <div class="row add-top add-bottom">
          <article class="col-md-12 text-left">
            <p class="welcome-text welcome-text-alt fx fx-slideInRight">We offer premium services, We can produce quality websites, designs, apps and artworks</p>
          </article>
        </div>
        ...
        <div class="row add-top">
         ...
         <ul id="rb-grid" class="rb-grid clearfix">
                  ...
                  <div id="service-carousel-01" class="carousel slide">
                      ...
                      <div class="carousel-inner">
                              ...
                              <div class="item active">
                                  <img alt="" title="" class="service-spec-img" src="images/services/specs/01.jpg"/>
                                  <div class="carousel-caption"></div>
                              </div>

                              <div class="item">
                                  <img alt="" title="" class="service-spec-img" src="images/services/specs/02.jpg"/>
                                  <div class="carousel-caption"></div>
                              </div>

                              <div class="item">
                                  <img alt="" title="" class="service-spec-img" src="images/services/specs/03.jpg"/>
                                  <div class="carousel-caption"></div>
                              </div>
          ...
          <li class="rb-span-4 next-bg-six">
            ...
            <img alt="" title="" class="service-thumb" src="images/services/04.png"/>
            <div class="rb-overlay">
              <span class="rb-close">close</span>
              <!-- service-content : starts -->
          ...
          <li class="rb-span-2 next-bg-eight">
            ...
            <img alt="" title="" class="service-thumb" src="images/services/06.png"/>
            <div class="rb-overlay">
            <span class="rb-close">close</span>
...
<section id="contact" class="page-section" >
      ...
      <section class="container">
        ...
        <div class="row">
          <article class="col-md-12 text-left">
            <h2 class="page-heading page-heading-alt">contact us</h2>
            <div class="liner"><span></span></div>
          </article>
        </div>
        ...
        <div class="row add-top add-bottom">
          <article class="col-md-12 text-left">
            <p class="welcome-text welcome-text-alt fx fx-slideInDown">We will reply to each and every email. If you have projects feel free to call us anytime</p>
          </article>
        </div>
...
<section id="address-panel" class="page-section">
      ...
      <section class="container">
        ...
        <div class="row">
          <article class="col-md-12 text-left">
            <h2 class="page-heading">connect us</h2>
            <div class="liner"><span></span></div>
          </article>
        </div>
        ...
        <div class="row add-top">
          <article class="col-md-12 text-left fx fx-flipInX">
            <p class="welcome-text">Solvato Online Business Solutions<br/>
            57/805, Temple Road,<br/>
            P.O.Kadavanthra,Elamkulam</p>
        ...
        <div class="row add-top connect fx fx-flipInY">
          <article class="col-md-4 text-left">
            <h3>Ph: 0484 4035527</h3>
          </article>
          <article class="col-md-4 text-center">
            <h3>contact@solvato.in</h3>
          </article>
        ...
        <div class="row add-top-half add-bottom">
          <article class="col-md-12 social-block text-left">
                  <a href="#"><img alt="next" title="next" src="images/contact/01.png"/></a>
                  <a href="#"><img alt="next" title="next" src="images/contact/02.png"/></a>
                  <a href="#"><img alt="next" title="next" src="images/contact/03.png"/></a>
                  <a href="#"><img alt="next" title="next" src="images/contact/04.png"/></a>
                </article>
        </div>
...
<footer id="mastfoot">
        ...
        <div class="row">
                <article class="col-md-6 credits text-left">
                  <p>Copyright &copy; 2013 Solvato. <br/>All rights reserved</p>
                </article>
                <article class="col-md-6 foot-icons text-right">
                  <ul class="clearfix text-right">
                    <li><a href="#"><img alt="" title="" src="images/footer/01.png"/></a></li>
                    <li><a href="#"><img alt="" title="" src="images/footer/02.png"/></a></li>
                  </ul>
                </article>
        </div>
